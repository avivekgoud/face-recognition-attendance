          ...
          ` : `
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-center p-6 rounded-2xl bg-slate-900/60 border border-slate-700/60">
              <div>
                ...
                <p class="text-xs text-slate-400 mt-1">Sign in with your administrator credentials to configure facial similarity thresholds, create department shifts, or override attendance.</p>
                <div class="mt-3 p-3 rounded-xl bg-slate-800/80 border border-slate-700/60 text-[11px] text-slate-400">
                  <div class="flex items-center gap-2 text-slate-300 font-semibold mb-1">
                    <svg class="w-3.5 h-3.5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                    <span>Secure Access Control</span>
                  </div>
                  <span>Authorized faculty and administration officers only.</span>
                </div>
              </div>

              <form onsubmit="window.handleSettingsLogin(event)" class="space-y-3">
                <div>
                  <label class="block text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1">Username or Email</label>
                  <input type="text" id="set-login-username" value="" placeholder="Enter username or email" required class="w-full px-3.5 py-2.5 rounded-xl bg-slate-800 border border-slate-700 text-white text-xs placeholder-slate-500 focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                  <label class="block text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1">Password</label>
                  <input type="password" id="set-login-password" value="" placeholder="••••••••" required class="w-full px-3.5 py-2.5 rounded-xl bg-slate-800 border border-slate-700 text-white text-xs placeholder-slate-500 focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <button type="submit" id="btn-settings-login" class="w-full py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-bold rounded-xl shadow-lg shadow-blue-500/25 transition-all">
